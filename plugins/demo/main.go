...
type GooseInstance struct {
	...
	logger *logrus.Logger // 实例级 logger / per-instance logger
	ctx    context.Context
...
func (f *GooseFactory) Type() string { return "demo" }
...
var Factory pluginapi.Factory = &GooseFactory{}
